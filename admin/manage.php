...
?>
<?php
//INSERT INTO `visitor` (`sno`, `Visitor Name`, `Phone Number`, `Address`, `Flat No`, `Wing`, `Whom to meet`, `Reason To Meet`, `Check In`, `Check Out`) VALUES ('1', 'Jay', '123456', 'Chikhali', '201', 'C', 'Jay', 'Personal', current_timestamp(), current_timestamp());
//INSERT INTO `visitor` (`sno`, `Visitor Name`, `Phone Number`, `Address`, `Flat No`, `Wing`, `Whom to meet`, `Reason To Meet`, `Check In`, `Remark`, `Check Out`) VALUES (NULL, 'lal', '123', 'Dehu', '401', 'B', 'Jay', 'Personal', current_timestamp(), NULL, NULL);
...
if(isset($_GET['delete'])){
    $sno = $_GET['delete'];
    //$delete = true;
    $sql = "DELETE FROM `visitor` WHERE `sno` = $sno";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = "UPDATE `visitor` SET `VisitorName` = '$vname', `PhoneNumber` = '$pno', `Address` = '$add', `FlatNo` = '$flatno', `Wing` = '$wing', `Whomtomeet` = '$wtm', `ReasonToMeet` = '$rtm', `Remark` = '$remark' WHERE `visitor`.`sno` = $sno";
    $result = mysqli_query($conn, $sql);
    if($result){
      $update = true;
  }
                ...
                <form action="#" method="POST">
                    ...
                    <input type="hidden" name="snoEdit" id="snoEdit">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="editvname" name="editvname">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="phonenumber" class="col-sm-2 col-form-label">Phone Number</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="editpno" name="editpno">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="address" class="col-sm-2 col-form-label">Address</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" id="editadd" rows="3" name="editadd"></textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="FlatNo" class="col-sm-2 col-form-label">Flat No.</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="editflatno" name="editflatno">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="wing" class="col-sm-2 col-form-label">Wing</label>
                            <div class="col-sm-10">
                                <input type class="form-control" id="editwing" rows="3" name="editwing">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="Whom to meet" class="col-sm-2 col-form-label">Whom to Meet</label>
                            <div class="col-sm-10">
                                <input type class="form-control" id="editwtm" rows="3" name="editwtm">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="Reason To Meet" class="col-sm-2 col-form-label">Reason To Meet</label>
                            <div class="col-sm-10">
                                <input type class="form-control" id="editrtm" rows="3" name="editrtm">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="Check In" class="col-sm-2 col-form-label">Check In</label>
                            <div class="col-sm-10">
                                <input type class="form-control" id="editcheckin" rows="3" name="editcheckin"> 
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="Check In" class="col-sm-2 col-form-label">Check Out</label>
                            <div class="col-sm-10">
                                <input type class="form-control" id="editcheckout" rows="3" name="editcheckout"> 
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type class="form-control" id="editremark" rows="3" name="editremark">
                            </div>
                        </div>
                ...
                <tbody>
                    <?php  
                        ...
                        $result = mysqli_query($conn, $sql);
                            ...
                            <td>". $row['CheckOut'] . "</td>
                            <td>". $row['Remark'] . "</td>
                            <td width='10%'><button class='edit btn btn-sm btn-primary' id=".$row['sno'].">Edit</button>
      ...
      $('#myTable').DataTable();
        ...
        <script>
            ...
            element.addEventListener("click", (e) => {
                ...
                cout = tr.getElementsByTagName("td")[8].innerText;
                rem = tr.getElementsByTagName("td")[9].innerText;
                console.log(vname, pno,add,flatno,wing,wtm,rtm,cin,cout,rem);
        ...
        if (confirm("Are you sure you want to delete this record!")) {
          console.log("yes");
          window.location = `manage.php?delete=${sno}`;
